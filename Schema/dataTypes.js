...
/**
 * this function defines the needed data types for a schema
 * @param {object} users db Model for users
 * @param {object} products db Model for products
 * @return {{productType:object, userType:object}} object types definition
 */
